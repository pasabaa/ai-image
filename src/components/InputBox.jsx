...
export const InputBox = ({label, setAttribute, description, placeholder}) => {
  return (
    <div className='flex flex-col gap-2 my-4'>
        ...
        <input autoFocus={true} placeholder={placeholder} className='border rounded py-1 px-3 text-sm text-gray-600 focus:outline-none active:outline-none' onChange={(e)=>setAttribute(e.target.value)} />
    </div>
  )
}
